...
# ============================================================================
#  AutoHunter 引导安装脚本
#  Powered By StanleyNull   QQ:754276250
#
...
banner() {
  ...
  cat <<'BANNER'
    ...
    ___         __        __  __            __
   /   | __  __/ /_____  / / / /_  ______  / /____  _____
  / /| |/ / / / __/ __ \/ /_/ / / / / __ \/ __/ _ \/ ___/
 / ___ / /_/ / /_/ /_/ / __  / /_/ / / / / /_/  __/ /
/_/  |_\__,_/\__/\____/_/ /_/\__,_/_/ /_/\__/\___/_/

         AI 自主漏洞挖掘平台  ·  Autonomous Bug Hunter
                    >>  锁定 · 侦察 · 出洞  <<
BANNER
  printf "${C_RESET}"
  printf "${C_DIM}        Powered By StanleyNull    QQ:754276250${C_RESET}\n\n"
}
...
print_summary() {
  ...
  printf "${C_GREEN}${C_BOLD}  部署完成  ·  Powered By StanleyNull  QQ:754276250${C_RESET}\n"
